...
public class DatabaseOpenHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        sqLiteDatabase.execSQL("create table items (itemId integer primary key autoincrement, itemName text not null, category integer not null, description text, image text, avgRating double default 0, longitude double, latitude double)");
