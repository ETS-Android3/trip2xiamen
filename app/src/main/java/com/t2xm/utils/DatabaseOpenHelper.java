...
public class DatabaseOpenHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        sqLiteDatabase.execSQL("create table reviews (reviewId integer primary key autoincrement, itemId integer not null, userId integer not null, reviewText text, rating integer not null, recommend integer not null, time long not null)");
        ...
        sqLiteDatabase.execSQL("create table items (itemId integer primary key autoincrement, itemName text not null, category integer not null, description text, phoneNumber text, officialWebsite text, travelInformationWebsite, image text, avgRating double default 0, longitude double, latitude double)");
